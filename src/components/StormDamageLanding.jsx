...
const allReviews = [
  {
    name: "Sarah T.",
    text: "After Hurricane Florence damaged our roof, Priceless Home Improvements handled everything with our insurance company. We got a brand new roof and only paid our $1,000 deductible. The whole process was seamless and stress-free!",
    rating: 5,
  ...
  {
    name: "Mike R.",
    text: "Storm damage had us worried about expensive repairs. Priceless showed us how to get insurance to cover everything. Professional crew, quality work, and we saved thousands. Highly recommend for any storm damage claims!",
    rating: 5,
    location: "Wilmington, NC",
  ...
  {
    name: "Jennifer L.",
    text: "I had no idea insurance would cover storm damage from last year's hail storm. Priceless walked me through the entire claims process and got me a $18,000 roof replacement for just my deductible. Amazing service!",
    rating: 5,
    location: "Wilmington, NC",
...
const StormDamageLanding = () => {
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      {/* Hero Section */}
      <section className="relative bg-gradient-to-r from-red-600/90 to-orange-600/70 text-white">
        <div 
        ...
        <div className="relative container mx-auto px-4 py-8 md:py-20">
          ...
          <div className="block md:hidden">
            ...
            <h1 className="text-2xl font-bold mb-4 leading-tight">
              ...
              <span className="block text-lg mt-2 text-yellow-300">Get Your Insurance Claim Filed Before It's Too Late - FREE Assessment!</span>
            </h1>
            ...
            <div className="grid grid-cols-1 gap-3 mb-6">
              <div className="flex items-center space-x-2">
                ...
                <span className="text-sm font-semibold">FREE Storm Damage Assessment</span>
              </div>
              <div className="flex items-center space-x-2">
                <div className="bg-green-500 rounded-full p-1.5">
                  <AlertTriangle className="h-4 w-4" />
                </div>
                <span className="text-sm font-semibold">Emergency Claim Filing</span>
              </div>
              <div className="flex items-center space-x-2">
                <div className="bg-green-500 rounded-full p-1.5">
                  <Award className="h-4 w-4" />
                </div>
                <span className="text-sm font-semibold">Storm Damage Specialists</span>
              </div>
              <div className="flex items-center space-x-2">
                <div className="bg-green-500 rounded-full p-1.5">
                  <Shield className="h-4 w-4" />
                </div>
                <span className="text-sm font-semibold">100% Insurance Approved</span>
              </div>
            </div>
