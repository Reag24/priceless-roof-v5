...
const SimpleLanding = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (response.ok) {
        trackFormSubmission('simple_landing_form');
        navigate("/thankyou");
      } else {
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            <div className="bg-gray-50 rounded-lg p-8 shadow-md">
              ...
              <div className="mt-6">
                <Button size="lg" variant="secondary" className="text-xl px-6 py-3 bg-primary text-white hover:bg-primary/90" onClick={scrollToForm}>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
            {[house1, house2, house3, house4, house5, house6].map((img, index) => (
