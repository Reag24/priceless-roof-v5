...
const HighConvertingLanding = () => {
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      {/* Scarcity Section */}
      <section className="py-6 md:py-8 bg-yellow-100 border-t-4 border-yellow-500">
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-6">
              <div className="bg-white p-3 md:p-4 rounded-lg shadow-md">
                <div className="text-xl md:text-2xl font-bold text-red-600 mb-2">1 YEAR</div>
                <p className="text-sm md:text-base text-gray-700">Maximum time to file storm damage claims</p>
              </div>
              <div className="bg-white p-3 md:p-4 rounded-lg shadow-md">
                <div className="text-xl md:text-2xl font-bold text-green-600 mb-2">$15,000+</div>
                <p className="text-sm md:text-base text-gray-700">Average roof replacement value</p>
              </div>
              <div className="bg-white p-3 md:p-4 rounded-lg shadow-md">
                <div className="text-xl md:text-2xl font-bold text-blue-600 mb-2">FREE</div>
                <p className="text-sm md:text-base text-gray-700">Emergency Leak Stop</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="py-12 md:py-16 bg-gradient-to-r from-green-50 to-blue-50">
        <div className="container mx-auto px-4 text-center">
          <h3 className="text-2xl md:text-3xl lg:text-5xl font-bold mb-4 md:mb-6 text-gray-800">Our ZERO-RISK Guarantee</h3>
          <p className="text-lg md:text-xl lg:text-2xl mb-6 md:mb-8 max-w-4xl mx-auto text-gray-700 font-semibold">
            We're so confident in our process, we put our money where our mouth is:
          </p>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8 max-w-5xl mx-auto">
            <Card className="bg-white p-4 md:p-6 lg:p-8 shadow-xl border-l-4 md:border-l-8 border-red-500 transform hover:scale-105 transition-transform">
              <div className="text-4xl md:text-6xl mb-3 md:mb-4">❌</div>
              <CardTitle className="text-xl md:text-2xl lg:text-3xl font-bold text-red-600 mb-3 md:mb-4">If Your Claim is DENIED:</CardTitle>
              <CardDescription className="text-base md:text-lg lg:text-2xl text-gray-800 font-semibold">
                You owe us $0. Not a penny. Our inspection, paperwork, and time are completely FREE.
              </CardDescription>
            </Card>
            <Card className="bg-white p-4 md:p-6 lg:p-8 shadow-xl border-l-4 md:border-l-8 border-green-500 transform hover:scale-105 transition-transform">
              <div className="text-4xl md:text-6xl mb-3 md:mb-4">✅</div>
              <CardTitle className="text-xl md:text-2xl lg:text-3xl font-bold text-green-600 mb-3 md:mb-4">If Your Claim is APPROVED:</CardTitle>
              <CardDescription className="text-base md:text-lg lg:text-2xl text-gray-800 font-semibold">
          ...
          <div className="mt-8 md:mt-12">
            <div className="bg-gradient-to-r from-yellow-400 to-orange-400 text-black px-4 md:px-6 lg:px-8 py-3 md:py-4 rounded-full inline-block shadow-lg">
              <span className="text-sm md:text-lg lg:text-2xl font-bold">🛡️ 100% SATISFACTION GUARANTEED OR YOUR MONEY BACK</span>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-12 md:py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="text-center mb-8 md:mb-12">
            <h3 className="text-2xl md:text-3xl lg:text-4xl font-bold mb-4 md:mb-6">Why 500+ Wilmington Families Choose Priceless</h3>
            <div className="flex justify-center items-center space-x-1 mb-4 md:mb-6">
              {[...Array(5)].map((_, i) => (
                <Star key={i} className="h-6 w-6 md:h-8 md:w-8 lg:h-10 lg:w-10 fill-yellow-400 text-yellow-400" />
              ))}
              <span className="ml-2 md:ml-4 text-xl md:text-2xl lg:text-3xl font-bold text-gray-800">18/18 5-Star Reviews</span>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8 mb-8 md:mb-12">
            <Card className="text-center hover:shadow-xl transition-shadow border-2 border-primary/20">
              <CardContent className="pt-6 md:pt-8">
                <div className="bg-primary/10 rounded-full p-3 md:p-4 w-16 h-16 md:w-20 md:h-20 lg:w-24 lg:h-24 mx-auto mb-4 md:mb-6 flex items-center justify-center">
                  <Shield className="h-8 w-8 md:h-10 md:w-10 lg:h-12 lg:w-12 text-primary" />
                </div>
                <h4 className="text-lg md:text-xl lg:text-2xl font-bold mb-3 md:mb-4">Licensed & Insured</h4>
            ...
            <Card className="text-center hover:shadow-xl transition-shadow border-2 border-primary/20">
              <CardContent className="pt-6 md:pt-8">
                <div className="bg-primary/10 rounded-full p-3 md:p-4 w-16 h-16 md:w-20 md:h-20 lg:w-24 lg:h-24 mx-auto mb-4 md:mb-6 flex items-center justify-center">
                  <img src={ikoLogo} alt="IKO Certified" className="h-10 md:h-12 lg:h-16" />
                </div>
                <h4 className="text-lg md:text-xl lg:text-2xl font-bold mb-3 md:mb-4">IKO Certified Experts</h4>
                <p className="text-sm md:text-base lg:text-lg text-muted-foreground">
            ...
            <Card className="text-center hover:shadow-xl transition-shadow border-2 border-primary/20">
              <CardContent className="pt-6 md:pt-8">
                <div className="bg-primary/10 rounded-full p-3 md:p-4 w-16 h-16 md:w-20 md:h-20 lg:w-24 lg:h-24 mx-auto mb-4 md:mb-6 flex items-center justify-center">
                  <Award className="h-8 w-8 md:h-10 md:w-10 lg:h-12 lg:w-12 text-primary" />
                </div>
                <h4 className="text-lg md:text-xl lg:text-2xl font-bold mb-3 md:mb-4">Award-Winning Service</h4>
                <p className="text-sm md:text-base lg:text-lg text-muted-foreground">
      ...
      <section className="py-12 md:py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="text-center mb-8 md:mb-12">
            <h3 className="text-2xl md:text-3xl lg:text-4xl font-bold mb-3 md:mb-4">Real Stories from Real Customers</h3>
            <p className="text-base md:text-lg lg:text-xl text-muted-foreground">See how we've helped Wilmington homeowners save thousands</p>
          </div>
      ...
      <section className="py-12 md:py-16 bg-white">
        <div className="container mx-auto px-4">
          <h3 className="text-2xl md:text-3xl lg:text-4xl font-bold text-center mb-8 md:mb-12">Our Premium Work in Wilmington</h3>
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 md:gap-6">
            {images.map((img, index) => (
              <div key={index} className="overflow-hidden rounded-lg shadow-lg hover:shadow-xl transition-shadow">
                <img src={img} alt={`Premium roofing project ${index + 1}`} className="w-full h-48 md:h-64 object-cover transform hover:scale-110 transition-transform duration-500" />
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="py-12 md:py-16 lg:py-20 bg-gradient-to-r from-red-600 to-red-700 text-white">
        <div className="container mx-auto px-4 text-center">
          <h3 className="text-2xl md:text-3xl lg:text-5xl font-bold mb-4 md:mb-6">Don't Let Your Insurance Money Expire!</h3>
